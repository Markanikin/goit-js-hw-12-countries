...
inputRef.addEventListener('input', (0, _lodashDebounceDefault.default)(onSearch, DEBOUNCE_DELAY));
function onSearch(e) {
    ...
    (0, _fetchCountriesDefault.default)(query).then((data)=>renderCountries(data)).catch(()=>{
        (0, _core.error)({
...
function renderCountries(countries) {
    ...
    if (countries.length > 10) {
        (0, _core.notice)({
            text: "\u0417\u043D\u0430\u0439\u0434\u0435\u043D\u043E \u0431\u0456\u043B\u044C\u0448\u0435 10 \u043A\u0440\u0430\u0457\u043D \u2014 \u0443\u0442\u043E\u0447\u043D\u0456\u0442\u044C \u0437\u0430\u043F\u0438\u0442!"
        });
        return;
    }
    ...
    if (countries.length === 1) {
      ...
      <div class="country-card">
        <div class="meta">
          <h2>${c.name}</h2>
          <p><b>\u{421}\u{442}\u{43E}\u{43B}\u{438}\u{446}\u{44F}:</b> ${c.capital}</p>
          <p><b>\u{41D}\u{430}\u{441}\u{435}\u{43B}\u{435}\u{43D}\u{43D}\u{44F}:</b> ${c.population}</p>
          <p><b>\u{41C}\u{43E}\u{432}\u{438}:</b> ${c.languages.map((l)=>l.name).join(', ')}</p>
        </div>
        <div>
...
},{"lodash.debounce":"irvaP","./fetchCountries":"bCGdT","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./style.css":"bhJkM"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}],"bhJkM":[function() {},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequirec490", {})
